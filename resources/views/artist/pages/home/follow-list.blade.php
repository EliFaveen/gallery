                        ...
                        <div class="card user-card">
                            <div class="card-horizontal">
                                <div class="img-square-wrapper">
                                    ...
                                    @else
                                        <div class="post-img-parent post-img-parent2">
                                            <img  class=" post-img post-img2 pl-0 pr-0 mr-0 ml-0" src="{{url('assets/all_pages/img/default_profile/default_profile_green.png')}}" alt="default image">
                                        </div>
                                    @endif
                                </div>
        ...
        <div class="row justify-content-center mt-4 mb-4">
            <div class="col-md-6">
                <div class="no-post-image-parent">
                    <img class="no-post-image" src="{{url('/assets/all_pages/img/defaults/follow-icon.png')}}" alt="enter-post-image" >
                </div>
            </div>
        </div>
    @endif
